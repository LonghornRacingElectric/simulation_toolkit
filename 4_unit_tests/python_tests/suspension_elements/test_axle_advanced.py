...
class TestAxleAdvanced(TestCase):
    ...
    # Tire
    tire_mf52_L = MF52(tire_name="test_tire", file_path="./1_model_inputs/Modified_Round_8_Hoosier_R25B_16x7p5_10_on_7in_12psi_PAC02_UM2.tir")
    ...
    # Tire
    tire_mf52_R = MF52(tire_name="test_tire", file_path="./1_model_inputs/Modified_Round_8_Hoosier_R25B_16x7p5_10_on_7in_12psi_PAC02_UM2.tir")

...
StaticMatrix<double, 3UL, 3UL> rotation_matrix(StaticVector<double, 3UL>, double);
...
StaticVector<double, 6UL> plane(StaticMatrix<double, 3UL, 3UL> &);
...
StaticVector<double, 3UL> plane_eval(StaticMatrix<double, 3UL, 3UL> &, double, double);
#endif //MISC_LINALG
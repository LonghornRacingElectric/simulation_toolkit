...
class LadyLuck(Car):
    def __init__(self):
        ...
        self.front_tire_coeff_Fy = ConstantParameter([3.06312013e-01, -4.84039800e-04, 9.28662043e+00, 7.26482752e+02, 1.37727265e+03, 4.12679421e-02, 2.53429368e-05, 1.01054136e+00, 0, 0, 0, 0, 0, 0, 0, -1.13901618e-03, -1.56217480e-02, -4.89395709e-04])  # coeffs
        self.front_tire_coeff_Fx = ConstantParameter([1.6273891721090612, -698.8419595678488, 3484.805352225537, 0.05134138933309365, 767.1901442937605, 0.3582710405478557, -1.6410632545280734, 3.169678791610308, -1.1006443264258339, 0, 0, 0, 0, 0])  # coeffs
        self.rear_tire_coeff_Fy = ConstantParameter([3.06312013e-01, -4.84039800e-04, 9.28662043e+00, 7.26482752e+02, 1.37727265e+03, 4.12679421e-02, 2.53429368e-05, 1.01054136e+00, 0, 0, 0, 0, 0, 0, 0, -1.13901618e-03, -1.56217480e-02, -4.89395709e-04])  # coeffs
        self.rear_tire_coeff_Fx = ConstantParameter([1.6273891721090612, -698.8419595678488, 3484.805352225537, 0.05134138933309365, 767.1901442937605, 0.3582710405478557, -1.6410632545280734, 3.169678791610308, -1.1006443264258339, 0, 0, 0, 0, 0])  # coeffs
        ...
        self.front_unsprung_inertia = ConstantParameter(0.1)  # [kgm^2] TODO lots of ptn are placeholders
        self.rear_unsprung_inertia = ConstantParameter(0.1)  # [kgm^2]

...
class YMD:
    ...
    def _residual_function_2(self, x: Sequence[float], args: Sequence[float]) -> Sequence[float]:
        ...
        self.FL_Cp_pos = self.FL_Cp.position - cg_pos
        self.FR_Cp_pos = self.FR_Cp.position - cg_pos
        self.RL_Cp_pos = self.RL_Cp.position - cg_pos
        self.RR_Cp_pos = self.RR_Cp.position - cg_pos
